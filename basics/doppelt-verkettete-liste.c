/*
Beispiel fuer eine doppelt verkettete Liste
...
int insert_node(char *s)
{
  ...
  if(anfang == NULL)
  ...
  else
    {
      ...
      // Der neue Knoten muss auf den ehemals letzten zeigen
      knoten->before = ende;
...
int delete_node(char *s)
{
  ...
  // Der nachfolgende Knoten muss auf den vorherigen zeigen.
